...
#
# Generated by export_simulation on Sat Dec 02 13:28:12 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './ip_clk_gen.sh' script.

./ip_clk_gen.sh -reset_run
...
./ip_clk_gen.sh -noclean_files

For more information on the script, please type './ip_clk_gen.sh -help'.
